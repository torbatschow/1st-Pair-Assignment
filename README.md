...
The assignment will be managed in a folder. The folder will contain R-Scripts for getting and cleaning the data and a separate script to analyse/represent the data. 
